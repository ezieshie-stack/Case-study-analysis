...
def build():
    ...
    S.append(p(
        ...
        "356 of them in Cleveland during this window, and those claims stick 88% of the time. The marketplace "
        "already recovers about seven of these failed shifts a day on its own. The target is three or four more "
        "a day (about 104 a month), roughly half again as many, routed through a pool that already does exactly "
        "this.", bullet))
    S.append(p(
