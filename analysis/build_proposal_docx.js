...
function buildBody() {
  ...
  S.push(leadPara("Re-offer it right away to the same-day pool.",
    ...
    "The marketplace already recovers about seven of these failed shifts a day on its own. The target is three " +
    "or four more a day (about 104 a month), roughly half again as many, routed through a pool that already " +
    "does exactly this.", true));
