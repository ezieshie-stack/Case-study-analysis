...
function buildBody() {
  ...
  S.push(leadPara("Detect the failure the moment it happens.",
    ...
    "no-shows get reported within an hour of the start time, against roughly 2% today.", true));
  ...
  S.push(table([
    ...
    ["No-shows reported within 1h of shift start", "~2%", "≥50%", "Leading indicator, weekly"],
  ...
  S.push(para(
    ...
    "roughly $75 we take on each rescued shift. I am leaving that spend out of this proposal on purpose. It is the " +
