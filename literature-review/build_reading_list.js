  ...
  sections: [{
    ...
    children: [
      ...
      ...src({
        ...
        use: 'The theoretical spine of your review, not a foil. They criticise the coherence ideal your paradox depends on, and they connect integration to control, the same move Fleming and Sturdy and Müller make empirically. Your gap is sharper than it looked: this paper builds the bridge between inside and outside without ever naming authenticity as what crosses it.',
        flag: 'You have the full text. Verified in the article itself: polyphony is argued at length, the coherence ideal is criticised directly, and the word authenticity never appears once in 32 pages. Quote it with confidence.',
      }),
      ...src({
